...
for time, percentagefailed in error_requests:
    print(" \"{}\" -- {} % errors".format(time, percentagefailed))
# conn commit #
conn.commit()

# conn close # W292	63	17	no newline at end of file How to solve it ??
conn.close()